    ...
    <div className="flex flex-col text-center justify-center text-white">
      ...
      <div className="bg-[#00171f] w-full h-[300px] sm:h-[400px] flex flex-col justify-center items-center my-auto mx-auto">
        ...
        <div className="flex flex-col w-full">
          ...
          />
          <select
            className="bg-[#407BFF] text-black font-semibold w-fit p-2 mx-auto my-3 rounded-md text-xl "
            value={imgSize}
            onChange={(e) => {
          ...
          <button
            className="bg-[#407BFF] text-black font-semibold w-fit p-2 mx-auto my-2 rounded-md text-2xl"
